...
/**
 * Struct Builtin Cmd - Represents a built-in command.
 *
 * @cmd: The command string.
 *
 * @action: A pointer to the function that executes the command's action.
 *
 * The Builtin Cmd struct defines a built-in command and its accompanied action.
 */
